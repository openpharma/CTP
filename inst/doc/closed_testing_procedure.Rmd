...
## Survival Analysis with the logrank test
 ...
 This example uses the sample dataset **ovarian** from the package **survival**. The overall survival curves of the two treatmens *rx* do not differ significantly:
