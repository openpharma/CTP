...
As an example, a positive response is defined as a change from baseline PASI score greater than 50. The new variable `Resp` has then the value 1 if `pasi.ch > 50` or 0 otherwise. The correspondinn model is chosen to be  generalized linear model with logit-link, as implemented in `glm`.  
